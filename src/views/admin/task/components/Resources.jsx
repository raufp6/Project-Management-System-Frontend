...
import PRSettings from '../../../../components/settings/PRSettings'
import Folders from '../../../../components/settings/Folders'
import AddFolders from '../../../../components/settings/AddFolders'
import Files from '../../../../components/settings/Files'
import ProjectInfo from '../../../../components/settings/ProjectInfo'
import TaskViewHeader from './TaskViewHeader'
import AddFile from '../../../../components/settings/AddFile'
import FileUploadModal from './FileUpload'
import AuthContext from '../../../../context/AuthContext'
import { sucessNotify } from '../../../../utils/toastUtils'
      ...
      <div className="grid grid-cols-12">
        <div className="2xl:col-span-9 col-span-12 2xl:border-r border-bgray-300">
          ...
          <div className="flex flex-wrap md:gap-x-10 gap-x-3 lg:gap-x-0 gap-y-5">
            ...
            <AddFile onclickhandle={setShowModal} />
          </div>
        </div>
      </div>
      {showModal ? (
        <FileUploadModal onclickhandle={setShowModal} modelstatus={showModal} />
      ) : null}
    </main>
  )
}
