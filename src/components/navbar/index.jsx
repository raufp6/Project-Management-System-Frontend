...
function Navbar() {
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-blueSecondary ">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        <Dropdown
          ...
          children={
            <div className="flex flex-col gap-5 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 m:w-[460px]">
