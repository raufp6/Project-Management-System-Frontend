...
import { isAdmin, isDeveloper } from '../../utils/Permission'

function SidebarEmplyee({ handleActive }) {
        ...
        <div className="nav-wrapper mb-[36px] pr-[50px]">
          <div className="item-wrapper mb-5">
            ...
            <ul className="mt-2.5">
              ...
              <li key="6" className={`item py-[11px] text-bgray-900`}>
                <Link
                  to="/admin/message"
                  className={`${
                    location.includes('message') ? 'nav-active' : ''
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
              ...
              <li
                key="6"
                className={`item py-[11px] text-bgray-900 ${
                  location === '/admin/settings' ? 'nav-active' : ''
                } `}
              >
                <Link
                  to="/admin/settings"
