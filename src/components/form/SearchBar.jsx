function SearchBar() {
  return (
    <div className="searchbar-wrapper">
      <div className="px flex h-[56px] w-[300px] items-center justify-between rounded-lg border border-transparent bg-bgray-50 px-4 focus-within:border-success-300  lg:w-[400px]">
        <div className="flex w-full items-center space-x-3.5">
          ...
          <label htmlFor="search" className="w-full">
            <input
              ...
              id="search"
              placeholder="Search..."
              className="search-input w-full border-none bg-bgray-50 bg-none px-0 text-sm tracking-wide text-bgray-600 placeholder:text-sm placeholder:font-semibold focus:outline-none focus:ring-0 "
            />
          </label>
        </div>
        <div className="flex items-center space-x-[6px]">
          ...
          <span className="text-base text-bgray-900">
            K
          </span>
        </div>
      </div>
