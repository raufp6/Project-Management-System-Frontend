  ...
  return (
    <div className="profile-wrapper text-left">
      <div
        ...
        className={`profile-box transition-all origin-top absolute right-0 top-[81px] hidden w-[300px] overflow-hidden rounded-lg bg-white  ${
                ...
                <Link to="/settings">
                  <div className="flex items-center space-x-[18px] rounded-lg p-[14px] text-bgray-600 hover:bg-bgray-100 hover:text-bgray-900">
                    ...
                    <div className="flex-1">
                      <span className="text-sm font-semibold text-bgray-900 ">
                        My Profile
                      </span>
                    </div>
                  </div>
