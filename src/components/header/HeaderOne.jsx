...
function HeaderOne({ handleSidebar }) {
  ...
  return (
    <header className="header-wrapper fixed z-30 hidden w-full md:block">
      <div className="relative flex h-[108px] w-full items-center justify-between bg-white px-10  2xl:px-[76px]">
        <button
          aria-label="none"
        ...
        {/* page-title */}
        <div>
          <h3 className="text-xl font-bold text-bgray-900  lg:text-3xl lg:leading-[36.4px]">
            Dashboard
          </h3>
          <p className="text-xs font-medium text-bgray-600  lg:text-sm lg:leading-[25.2px]">
