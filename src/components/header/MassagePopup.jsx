  ...
  return (
    <div className="message-popup-wrapper text-left">
      <div
        ...
        className={`absolute right-[0px] top-[81px] transition-all origin-top hidden w-[400px] rounded-lg bg-white  ${
      ...
      >
        <div className="relative w-full pb-[75px] pt-[66px]">
          <div className="absolute left-0 top-0 flex h-[66px] w-full items-center justify-between px-8">
            <h3 className="text-xl font-bold text-bgray-900 ">
              Message
            </h3>
            <span>
              <svg
          ...
          <div>
            <div className="flex items-center border-b border-bgray-200 ">
              <a
                aria-label="none"
            ...
            <ul className="scroll-style-1 h-[335px] w-full overflow-y-scroll">
              <li className="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100  ">
                <Link to="#">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="mb-1 text-base font-bold text-bgray-900  ">
                        James Eusobio
                      </p>
